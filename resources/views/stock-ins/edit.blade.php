...
<div class="p-6 max-w-6xl mx-auto">
  ...
  <div class="mb-6">
    <div class="flex items-center gap-4">
      ...
      <div>
        ...
        <p class="text-gray-600">Modify stock in transaction: {{ $stockIn->reference_number }}</p>
      </div>
    </div>
  </div>
  ...
  <div class="bg-white rounded-lg shadow">
    <form action="{{ route('stock-ins.update', $stockIn) }}" method="POST" class="p-6 space-y-6" x-data="stockInEditForm()">
      @csrf
      @method('PUT')
      ...
      <div class="grid md:grid-cols-3 gap-6">
        ...
        <div>
          ...
          <input type="text" 
                 ...
                 required
                 class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 @error('reference_number') border-red-500 @enderror">
      ...
      <div>
        ...
        <textarea id="notes" 
                  ...
                  placeholder="Enter any additional notes">{{ old('notes', $stockIn->notes) }}</textarea>
        @error('notes')
          <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
        @enderror
      </div>
