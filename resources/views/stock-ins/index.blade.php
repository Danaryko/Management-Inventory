...
<div class="p-6 max-w-7xl mx-auto">
  ...
  <div class="mb-6">
    <div class="flex justify-between items-center">
      <div>
        <h1 class="text-2xl font-bold text-gray-900">Stock In Transactions</h1>
        <p class="text-gray-600">Manage incoming stock transactions</p>
      </div>
  ...
  <div class="mb-6 bg-white rounded-lg shadow p-4">
    <form method="GET" action="{{ route('stock-ins.index') }}" class="grid md:grid-cols-5 gap-4">
      <div>
  ...
  <div class="bg-white rounded-lg shadow">
            ...
            @foreach($stockIns as $stockIn)
              <tr class="hover:bg-gray-50">
                <td class="px-6 py-4 whitespace-nowrap">
                  <div class="text-sm font-medium text-gray-900">{{ $stockIn->reference_number }}</div>
                  @if($stockIn->notes)
                    <div class="text-sm text-gray-500">{{ Str::limit($stockIn->notes, 30) }}</div>
                  @endif
                </td>
    ...
    @else
      <div class="text-center py-12">
        ...
        <p class="mt-1 text-sm text-gray-500">Get started by creating a new stock in transaction.</p>
        <div class="mt-6">
          <a href="{{ route('stock-ins.create') }}" 
