    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-lg shadow p-6 mb-6">
            <div class="flex flex-col md:flex-row md:items-center md:justify-between">
                <div>
                    <h1 class="text-2xl font-bold text-gray-900">Laporan Stock Out</h1>
        ...
        <!-- Filter Form -->
        <div class="bg-white rounded-lg shadow p-6 mb-6">
            <form method="GET" action="{{ route('reports.stock-out') }}" class="space-y-4 md:space-y-0 md:flex md:items-end md:space-x-4">
                <div class="flex-1">
                ...
                <div class="flex space-x-2">
                    ...
                    <a href="{{ route('reports.stock-out.pdf', request()->query()) }}" 
            ...
            <div class="bg-white rounded-lg shadow p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-semibold text-gray-900">{{ $stockOuts->count() }}</p>
                    </div>
                </div>
            </div>
        ...
        <div class="bg-white rounded-lg shadow overflow-hidden">
            <div class="px-6 py-4 border-b border-gray-200">
                <h3 class="text-lg font-medium text-gray-900">Data Stock Out</h3>
            </div>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @foreach($stockOuts as $index => $stockOut)
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                        {{ number_format($stockOut->items->sum('quantity')) }}
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
            ...
            @else
                <div class="text-center py-12">
                    ...
                    <p class="mt-1 text-sm text-gray-500">Tidak ada transaksi stock out pada periode yang dipilih.</p>
                </div>
            @endif
        </div>
    </div>
